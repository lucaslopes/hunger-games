...
# from pettingzoo.classic import tictactoe_v3 as hunger_games_v0
...
def get_env(render_mode=None):
    return PettingZooEnv(hunger_games_v0.env(render_mode=render_mode))
